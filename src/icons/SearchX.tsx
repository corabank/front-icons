...
export const SearchX: React.FunctionComponent<Props> = props => (
  <StyledIcon {...props}>
    ...
    <path stroke="#3B3B3B" strokeLinecap="round" strokeLinejoin="round" d="M14.155 14.063l2.923 2.963L20 19.99M7.879 12.021L12.12 7.78m-4.242 0l4.242 4.242m-2.15 3.754a5.971 5.971 0 1 0 0-11.942 5.971 5.971 0 0 0 0 11.942z"/>
  </StyledIcon>
)
